export default {
  ...
  'start.title': '旅を始めよう',
  'start.subtitle': 'まず集めて、編集して、シェア',
  'start.importPhotos': '写真をインポート',
  'start.importPhotosDesc': '写真のGPSからスポットを自動作成',
  'start.pasteJson': 'AI JSONを貼り付け',
  'start.pasteJsonDesc': 'ChatGPT / Claude の結果を貼り付け',
  'start.manual': '地図から始める',
  'start.manualDesc': '手動でスポット追加・ルート描画',
  ...
  'postcard.create': '電子はがきを生成',
  'postcard.rendering': 'はがきを描画中…',
  'postcard.preview.title': 'はがきプレビュー',
  'postcard.download': 'ダウンロード',
  'postcard.close': '閉じる',
  'postcard.error': 'はがきの描画に失敗',

  // Time Slider
  'timeSlider.title': '年代',
  'timeSlider.toggle': '年代切替',
  'timeSlider.scaleGroup': '目盛グループ',
  'timeSlider.scale.history': '歴史地図の目盛',
  'timeSlider.scale.bible': '聖書叙事の目盛',
  'era.modern': '現代',
