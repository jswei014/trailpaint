export default {
  ...
  'start.subtitle': 'Collect first, edit, then share',
  'start.importPhotos': 'Import Photos',
  'start.importPhotosDesc': 'Photo GPS auto-creates spots',
  'start.pasteJson': 'Paste AI JSON',
  'start.pasteJsonDesc': 'Bring results back from ChatGPT / Claude',
  'start.manual': 'Start on the Map',
  'start.manualDesc': 'Add spots and draw routes by hand',
