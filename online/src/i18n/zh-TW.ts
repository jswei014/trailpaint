export default {
  ...
  'start.title': '開始一段旅程',
  'start.subtitle': '先收集，再編輯，最後分享',
  'start.importPhotos': '匯入照片',
  'start.importPhotosDesc': '照片 GPS 自動建立景點',
  'start.pasteJson': '貼上 AI JSON',
  'start.pasteJsonDesc': '從 ChatGPT / Claude 貼回成果',
  'start.manual': '從地圖開始',
  'start.manualDesc': '手動加景點、畫路線',
  ...
  'overlay.threeKingdoms262': '三國 (262)',
  ...
  'postcard.create': '產生電子明信片',
  'postcard.rendering': '繪製明信片中…',
  'postcard.preview.title': '電子明信片預覽',
  'postcard.download': '下載',
  'postcard.close': '關閉',
  'postcard.error': '明信片繪製失敗',

  // Time Slider
  'timeSlider.title': '年代',
  'timeSlider.toggle': '切換年代',
  'timeSlider.scaleGroup': '刻度組',
  'timeSlider.scale.history': '歷史地圖刻度',
  'timeSlider.scale.bible': '聖經敘事刻度',
  'era.modern': '現代',
